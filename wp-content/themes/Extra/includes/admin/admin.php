...
function et_add_extra_menu() {
	...
	if ( et_pb_is_allowed( 'module_customizer' ) ) {
		add_submenu_page( 'et_extra_options', esc_html__( 'Module Customizer', 'extra' ), esc_html__( 'Module Customizer', 'extra' ), 'manage_options', 'customize.php?et_customizer_option_set=module' );
	}
